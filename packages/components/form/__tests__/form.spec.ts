...
import installStyle from '@wisdom-plus/test-utils/style-plugin'
import Checkbox from '@wisdom-plus/components/checkbox/src/checkbox.vue'
import CheckboxGroup from '@wisdom-plus/components/checkbox/src/checkbox-group.vue'
